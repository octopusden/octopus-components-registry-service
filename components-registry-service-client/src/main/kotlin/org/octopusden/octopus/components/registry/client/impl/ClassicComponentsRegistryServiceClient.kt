...
class ClassicComponentsRegistryServiceClient(
    ...
    override fun findArtifactComponentsByArtifacts(artifacts: Set<ArtifactDependency>) = client.findArtifactComponentsByArtifacts(artifacts)

    override fun findComponentsByDockerImages(images: Set<Image>): Set<ComponentImage> = client.findComponentsByDockerImages(images)
    ...
    override fun getComponentDistribution(
        componentKey: String,
        version: String,
    ...
    override fun getVCSSetting(
        componentKey: String,
        version: String,
    ) = client.getVCSSetting(componentKey, version)
    ...
    ): List<BuildTool> = client.getBuildTools(componentKey, version, ignoreRequired)

    override fun getJiraComponentForComponentAndVersion(
        componentKey: String,
        version: String,
    ): JiraComponentVersionDTO = client.getJiraComponentForComponentAndVersion(componentKey, version)
    ...
    override fun getJiraComponentsByProject(projectKey: String): Set<String> = client.getJiraComponentsByProject(projectKey)

    override fun getJiraComponentVersionRangesByProject(projectKey: String) = client.getJiraComponentVersionRangesByProject(projectKey)

    override fun getComponentsDistributionByJiraProject(projectKey: String) = client.getComponentsDistributionByJiraProject(projectKey)
    ...
    override fun getDistributionForProject(
        projectKey: String,
        version: String,
    ): DistributionDTO = client.getDistributionForProject(projectKey, version)

    override fun getAllJiraComponentVersionRanges(): Set<JiraComponentVersionRangeDTO> = client.getAllJiraComponentVersionRanges()

    override fun getDependencyAliasToComponentMapping(): Map<String, String> = client.getDependencyAliasToComponentMapping()

    override fun getSupportedGroupIds(): Set<String> = client.getSupportedGroupIds()

    override fun getComponentProductMapping(): Map<String, ProductTypes> = client.getComponentProductMapping()

    override fun getVersionNames(): VersionNamesDTO = client.getVersionNames()

    override fun getServiceStatus(): ServiceStatusDTO = client.getServiceStatus()

    override fun getCopyrightByComponent(componentKey: String): Response = client.getCopyrightByComponent(componentKey)

    override fun findComponentByArtifact(artifact: ArtifactDependency): VersionedComponent = client.findComponentByArtifact(artifact)
