...
class ComponentRegistryServiceClientTest : BaseComponentsRegistryServiceTest() {
    ...
    fun testGetAllComponents() {
        assertEquals(51, componentsRegistryClient.getAllComponents().components.size)
        assertEquals(
            3,
        ...
        assertEquals(47, componentsRegistryClient.getAllComponents(systems = listOf("ALFA", "NONE")).components.size)
        assertEquals(51, componentsRegistryClient.getAllComponents(systems = listOf("CLASSIC", "NONE")).components.size)
        assertEquals(51, componentsRegistryClient.getAllComponents(systems = listOf("ALFA", "CLASSIC", "NONE", "TEST")).components.size)
    }
