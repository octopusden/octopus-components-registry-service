...
class ComponentRegistryServiceClientTest : BaseComponentsRegistryServiceTest() {
    ...
    fun testGetAllComponents() {
        assertEquals(54, componentsRegistryClient.getAllComponents().components.size)
        assertEquals(
            3,
        ...
        assertEquals(48, componentsRegistryClient.getAllComponents(systems = listOf("NONE")).components.size)
        assertEquals(6, componentsRegistryClient.getAllComponents(systems = listOf("ALFA", "CLASSIC")).components.size)
        assertEquals(50, componentsRegistryClient.getAllComponents(systems = listOf("ALFA", "NONE")).components.size)
        assertEquals(54, componentsRegistryClient.getAllComponents(systems = listOf("CLASSIC", "NONE")).components.size)
        assertEquals(54, componentsRegistryClient.getAllComponents(systems = listOf("ALFA", "CLASSIC", "NONE", "TEST")).components.size)
    }
