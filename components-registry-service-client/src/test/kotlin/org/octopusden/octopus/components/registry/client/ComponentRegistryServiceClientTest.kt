...
class ComponentRegistryServiceClientTest : BaseComponentsRegistryServiceTest() {
    ...
    fun testGetAllComponents() {
        assertEquals(50, componentsRegistryClient.getAllComponents().components.size)
        assertEquals(
            3,
        ...
        assertEquals(44, componentsRegistryClient.getAllComponents(systems = listOf("NONE")).components.size)
        assertEquals(6, componentsRegistryClient.getAllComponents(systems = listOf("ALFA", "CLASSIC")).components.size)
        assertEquals(46, componentsRegistryClient.getAllComponents(systems = listOf("ALFA", "NONE")).components.size)
        assertEquals(50, componentsRegistryClient.getAllComponents(systems = listOf("CLASSIC", "NONE")).components.size)
        assertEquals(50, componentsRegistryClient.getAllComponents(systems = listOf("ALFA", "CLASSIC", "NONE", "TEST")).components.size)
    }
