...
class ComponentRegistryServiceClientTest : BaseComponentsRegistryServiceTest() {
    ...
    fun testGetAllComponents() {
        assertEquals(55, componentsRegistryClient.getAllComponents().components.size)
        assertEquals(
            3,
        ...
        assertEquals(49, componentsRegistryClient.getAllComponents(systems = listOf("NONE")).components.size)
        assertEquals(6, componentsRegistryClient.getAllComponents(systems = listOf("ALFA", "CLASSIC")).components.size)
        assertEquals(51, componentsRegistryClient.getAllComponents(systems = listOf("ALFA", "NONE")).components.size)
        assertEquals(55, componentsRegistryClient.getAllComponents(systems = listOf("CLASSIC", "NONE")).components.size)
        assertEquals(55, componentsRegistryClient.getAllComponents(systems = listOf("ALFA", "CLASSIC", "NONE", "TEST")).components.size)
    }
