...
val DETAILED_COMPONENT_VERSION =
...
private fun createVcsSettings(version: String) =
    VCSSettingsDTO(
...
abstract class BaseComponentsRegistryServiceTest {
    ...
    protected abstract fun getDetailedComponent(
        component: String,
        version: String,
    ): DetailedComponent

    protected abstract fun getDetailedComponentVersion(
        component: String,
        version: String,
    ): DetailedComponentVersion
    ...
    protected abstract fun getVcsSettings(
        component: String,
        version: String,
    ): VCSSettingsDTO

    protected abstract fun getDistribution(
        component: String,
        version: String,
    ): DistributionDTO

    protected abstract fun getBuildTools(
        component: String,
        version: String,
    ): List<BuildTool>

    protected abstract fun getJiraComponentVersion(
        component: String,
        version: String,
    ...
    protected abstract fun getVCSSettingForProject(
        projectKey: String,
        version: String,
    ): VCSSettingsDTO

    protected abstract fun getDistributionForProject(
        projectKey: String,
        version: String,
    ): DistributionDTO
    ...
    @ValueSource(
        strings = [
            BUILD_VERSION, JIRA_BUILD_VERSION, LINE_VERSION, JIRA_LINE_VERSION,
            MINOR_VERSION, JIRA_MINOR_VERSION, RC_VERSION, JIRA_RC_VERSION,
            JIRA_RELEASE_VERSION, RELEASE_VERSION, HOTFIX_VERSION,
        ],
    )
    ...
    fun testGetJiraComponentByProjectAndVersion(
        projectKey: String,
        version: String,
        path: String,
    ) {
    ...
    fun testGetJiraComponentVersionRangesByProject() {
        ...
        val expectedJiraComponentVersionRanges =
            testDataDir
                .resolve("expected-data/sub-jira-component-version-ranges.json")
                .toObject(object : TypeReference<Set<JiraComponentVersionRangeDTO>>() {})
    ...
    fun testGetComponentsDistributionsByJiraProject() {
        ...
        val expectedComponentDistributions =
            testDataDir
                .resolve("expected-data/component-distributions.json")
    ...
    fun testGetVCSSettingForProject(
        projectKey: String,
        version: String,
        expectedPath: String,
    ) {
    ...
    fun testGetDistributionForProject(
        projectKey: String,
        version: String,
        path: String,
    ) {
    ...
    fun testGetComponentArtifactsParameters(
        component: String,
        path: String,
    ) {
    ...
    fun testFindByArtifact() {
        ...
        val expectedComponent =
            testDataDir
                .resolve("expected-data/sub-component2-versioned-component.json")
    ...
    fun testFindByArtifactsV3() {
        val artifacts =
            testDataDir
                .resolve("sub1-sub2-sub3-artifacts.json")
                .toObject(object : TypeReference<Set<ArtifactDependency>>() {})

        val actualArtifactComponents = findByArtifactsV3(artifacts)
        val expectedArtifactComponents =
            testDataDir
                .resolve("expected-data/sub1-sub2-sub3-artifact-components.json")
    ...
    companion object {
        ...
        fun getTestResourcesPath(): Path =
            Paths.get(BaseComponentsRegistryServiceTest::class.java.getResource("/expected-data")!!.toURI()).parent
        ...
        @JvmStatic
        fun mavenArtifacts(): Stream<Arguments> =
            Stream.of(
