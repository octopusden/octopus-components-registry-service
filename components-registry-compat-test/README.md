...
2. **`cluster-digest.md`** — active diffs grouped by endpoint + resolved entity (`componentName @ versionRange`) + normalised field path. Use this first for jira-ranges triage instead of decoding raw `$[N]` indices.
