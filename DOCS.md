...
|---|---|---|
| **Product requirements** | [`docs/registry/prd.md`](docs/registry/prd.md) | Goals, user stories, phases, milestones. |
| **Functional spec** | [`docs/registry/functional-spec.md`](docs/registry/functional-spec.md) | What the API does — CRUD, search, audit, import, info, auth. |
| **Non-functional spec** | [`docs/registry/non-functional-spec.md`](docs/registry/non-functional-spec.md) | Performance budgets, availability, observability, async-job SLAs. |
| **Technical design** | [`docs/registry/technical-design.md`](docs/registry/technical-design.md) | Architecture, DB schema, JPA entities, API contracts, security. |
| **Architecture decisions** | [`docs/registry/adr/`](docs/registry/adr/) | All ADRs — backend, data, security, including [ADR-012 Portal architecture](docs/registry/adr/012-portal-architecture.md) (canonical for the boundary). |
| **Numbered requirements** | [`requirements-common.md`](docs/registry/requirements-common.md) (`SYS-NNN`), [`requirements-migration.md`](docs/registry/requirements-migration.md) (`MIG-NNN`), [`requirements-resolver.md`](docs/registry/requirements-resolver.md) (`RES-NNN`) | Acceptance criteria + test pointers. SYS = system/API behaviour, MIG = Git→DB migration, RES = resolver parity (DB resolver vs Git resolver). |
| **Tech-debt entries** | [`docs/registry/tech-debt/`](docs/registry/tech-debt/) (`TD-NNN`) | Backend tech-debt: Flyway rollout, OpenAPI spec generation, etc. |
| **Local dev / deployment** | [`docs/registry/deployment/`](docs/registry/deployment/) | Dev runbooks, OKD deploy patterns, local Postgres. |
...
| **Portal architecture (BFF, CSRF, SPA fallback)** | `docs/architecture.md` | Implementation details with file pointers. Canonical decision is in CRS [ADR-012](docs/registry/adr/012-portal-architecture.md); the Portal doc is the implementation guide. |
...
|---|---|---|
| **Architecture / boundary contract** | [ADR-012 (canonical)](docs/registry/adr/012-portal-architecture.md) | `docs/architecture.md` (impl guide) + `docs/adr/001-...` (summary+link) |
| **OpenAPI spec generation** | [TD-003](docs/registry/tech-debt/003-openapi-v4-spec-generation.md) — backend-side wiring | `docs/tech-debt/TD-002-openapi-types.md` — frontend-side consumption |
| **Async migration UX** | [MIG-027 (contract)](docs/registry/requirements-migration.md), [MIG-028 (persisted state, open)](docs/registry/requirements-migration.md) | `docs/features/admin-migration.md` — SPA hooks, polling, fallback |
| **Auth model** | [ADR-004](docs/registry/adr/004-auth-keycloak.md) — role/permission matrix on resource server | `docs/architecture.md` §"BFF pattern" + `SecurityConfig.kt` |
| **Build info / footer** | [SYS-033](docs/registry/requirements-common.md) (`/rest/api/4/info`) | `docs/features/app-footer.md` — `/portal/info` + `/rest/api/4/info` consumed by `useInfo.ts` |
| **Identity** | [SYS-034](docs/registry/requirements-common.md) (`/auth/me`) | `frontend/src/hooks/useCurrentUser.ts` |
| **Cutover** | [ADR-013 — Cutover strategy](docs/registry/adr/013-cutover-strategy.md) (Proposed) | Affects Portal indirectly when Git resolver / `migrate-history` retire — see ADR-013 §Stage 5C |
