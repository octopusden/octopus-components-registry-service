...
- [x] 2.1 `V8__` migration + entity columns; migration test on Testcontainers (single- and
...
- [x] 2.2 DSL import back-fill for the secondary entries of multi-entry rows
- [x] 2.3 v4 request/response fields and round-trip
- [x] 2.4 Validation rules in `replaceVcsEntries` with `vcsEntries[<i>].<field>: ` errors (base and
