...
object id30Step2AggregateAuto : BuildType({
    ...
    steps {
        script {
            ...
            id = "FORCE_GREEN_STATUS"
            executionMode = BuildStep.ExecutionMode.ALWAYS
            scriptContent = "echo \"##teamcity[buildStatus status='SUCCESS' text='Reported fan-out status to GitHub']\""
        }
        stepsOrder = arrayListOf("Post_Github_Commit_Status_Success", "Post_Github_Commit_Status_Failed", "FORCE_GREEN_STATUS")
    }
})
